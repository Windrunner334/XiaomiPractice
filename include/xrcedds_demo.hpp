...
public:
    ...
    XRCEQueue<struct student> center_read_queue;
    //XRCEQueue<std::vector<uint8_t>> center_read_queue;
...
public:
    ...
    XRCEQueue<struct student> center_write_queue;
    //XRCEQueue<std::vector<uint8_t>> center_write_queue;
